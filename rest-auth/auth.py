...
# See https://github.com/volvlabs/towncryer-chat-server/rest-auth for details.
...
def index():
    return 'Sample Tinode REST/JSON-RPC authentication service. '+\
        'See <a href="https://github.com/volvlabs/towncryer-chat-server/rest-auth/">https://github.com/volvlabs/towncryer-chat-server/rest-auth/</a> for details.'
